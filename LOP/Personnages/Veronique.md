...
## Role
- Cheffe de la faction Sweepers ; cf. SB4 pour la doctrine des Sweepers.
...
- Apparition Ere 2 (1848) [DIVERGENCE RP] : en apparente bonne sante (sa Petrification lente est deja la, cachee - cf. Physique et sante), cheffe respectee des Sweepers. Lors d'un vacarme dans la rue (un pantin policier vire fou), elle intervient la premiere et PULVERISE le pantin de son marteau avant qu'il ne blesse un civil. Magnus, temoin, en est fascine : c'est cet acte qui lui donne l'envie de rejoindre les Stalkers. cf. Personnages/Magnus.md, Markiona.md.
- DLC Overture (timeline passee) :
  - Veronique et son avant-garde menes dans un piege par les Alchimistes (via Lumacchio, qui collude avec Simon).
  - Capturees ; infectees avec des "strange drugs" / la Petrification Disease.
  - Un membre survivant de l'avant-garde explique ce qui s'est passe : "Everything's wrong. What strange drugs did they fill me with?"
  - Veronique elle-meme essaie de s'accrocher a son humanite mais la rage l'emporte.
  - P la combat (boss du DLC dans la Zelator Facility).
  - Vaincue ; quelques-uns de ses derniers mots sont une excuse.
  - Evoque "the cursed lab" et "an abomination below" = le Two-Faced Overseer.
  - Demande a P de tuer l'abomination et d'aller a la cote pour trouver Lea Florence.
  - Meurt en coupant le coolant : libere l'air glacial (froid mortel) pour mettre fin a sa transformation.
  - [DIVERGENCE RP - continuite Magnus] Reorchestration : ici c'est LEA (presente) qui abat la Veronique devenue folle ; la confession de la trahison de Lumacchio et le remerciement s'adressent a Lea. Le coolant / le boss de P = canon, supplante dans le RP. cf. Sort connu, Personnages/Lea_Florence_Monad.md.
- Raison de son infection : avait creuse trop profond dans les affaires des stalkers impliques dans les experiences alchimiques, decouvrant la trahison de Lumacchio.
- Lumacchio reconnait dans sa confession tardive que "Veronique avait creuse trop profond" -> c'est pourquoi elle a ete infectee.
...
- [INTERPRETATION] Contraste direct avec Lumacchio : la ou Lumacchio choisit l'ambition et la trahison, Veronique choisit l'honneur jusqu'au bout.

## Relations
- Lumacchio (chef des Bastards) : adversaire de faction ; trahi et infecte par lui.
...
- Lea Florence Monad : Lumacchio planifiait de l'eliminer aussi ("she's a little bit stronger than Veronic"). [DIVERGENCE RP] En Ere 2, toutes deux figures de l'union des Stalkers (Lea unificatrice, Veronique cheffe Sweepers).
...
## Sort connu
- [DIVERGENCE RP] Distincte de sa Petrification lente (cf. Physique et sante) : sa fin vient d'un "remede" alchimiste qui est en realite une NEUROTOXINE arrangee par Lumacchio - elle la fait virer folle / muter en tres peu de temps (pas l'evolution insidieuse de la maladie lente).
- [DIVERGENCE RP - continuite Magnus] Reorchestration de sa mort : ce ne sont ni P ni le coolant qui l'achevent, mais LEA - qui doit l'abattre de sa main. Mourante, Veronique revele la trahison de Lumacchio et REMERCIE Lea (la seule des trois fieres a n'avoir eu personne pour la soigner n'est, au moins, pas seule a la fin). cf. Personnages/Lea_Florence_Monad.md, roadmap Ere 3.
- Anteriorite canon (supplantee par la version RP ci-dessus) : vaincue par P (boss de la Zelator Facility), elle meurt en coupant le coolant (air glacial) - mort autodeterminee pour stopper sa mutation, et oriente P vers Lea.

## Trajectoire datee
| Date/ere | Evenement | Delta d'etat |
|---|---|---|
| Pre-Frenzy | Cheffe des Sweepers ; installe les Stargazers | Respectee, active |
| 1848 (Les Loups) [DIVERGENCE RP] | Pulverise un pantin policier devenu fou avant qu'il ne blesse un civil ; inspire l'entree du duo chez les Stalkers. Porte deja une Petrification lente, cachee par fierte | Cheffe heroique, en vue ; malade en secret |
| 1850 (Overture, Ere 3) | Enquete sur les trahisons stalkers/Alchimistes ; decouvre la collusion de Lumacchio avec Simon | Menace pour Lumacchio |
| 1850 (Overture, Ere 3) | Piegee par les Alchimistes (via Lumacchio) ; le "remede" = neurotoxine de Lumacchio -> folie / mutation rapide (distincte de sa Petrification lente) | Captive, sombrant dans la folie |
| 1850 (Overture, Ere 3) [DIVERGENCE RP] | Devenue folle, ABATTUE par Lea (canon : boss de P / mort au coolant, supplante) ; mourante, revele la trahison de Lumacchio et remercie Lea | Morte ; la verite transmise a Lea |

---

FIN_WIKI_PERSONNAGES_VERONIQUE
