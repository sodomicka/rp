...
- Nom usuel : P (abrege dans le jeu et les dialogues). Forme canon : Pinocchio.
- Coquilles transcript : "Pee", "Pete", "Peace", "Pin", "Pier".
- Nature : pantin (puppet) a Ego eveille, protagoniste jouable de Lies of P.
- Createur : Giuseppe Geppetto.
...
- Protagoniste actif de la totalite du base game et du DLC Overture (dans le passe).
- Reveille par Sophia (papillon bleu) a Krat Central Station, dans un wagon abandonne. Geppetto ne pouvait pas l'activer lui-meme (pourchasse par le Mad Donkey).
- Mission initiale assignee par Sophia : rejoindre l'Hotel Krat pour retrouver Geppetto.
...
- Parcourt Krat en combattant puppets frenzy, Carcasses, alchimistes, boss majeurs :
  ...
  - Black Rabbit Brotherhood (plusieurs fois).
...
- [INTERPRETATION] P commence comme un outil : programmes par Geppetto pour rassembler de l'Ergo, pas de libre arbitre apparent.
...
- Geppetto (createur / antagoniste cache) : cree P comme outil de resurrection de Carlo. L'appelle "son". P le voit d'abord comme pere et guide, puis decouvre la manipulation via Law Zero / Romeo. Fin bad ending : P donne son coeur a Geppetto. Fin good/best ending : Geppetto se sacrifie pour proteger le coeur de P, P tue le Nameless et vit.
...
- Bad ending ("Free from the Strings") : P donne son P-Organ a Geppetto. Carlo renait dans un nouveau corps. P survit comme pantin sans coeur, recu une lettre de Geppetto l'avertissant de rester a l'hotel (corps reagit a l'Ergo a cause de l'Arm of God).
- Good ending / Best ending ("Real Boy") : P refuse de donner son coeur. Geppetto se sacrifie pour proteger le coeur. P detruit le Nameless Puppet. Best ending : verse une larme (quasi humain). Si cheveux gris, place l'Ergo de Sophia dans un pantin pour la faire revivre.
- Post-credits : Philip Paracelsus dans un train qualifie P de "nouveau type d'humanite" ; les experiences continuent. Dorothy = prochaine "cle". A Krat, une fille en chaussures rouges frappe ses talons (teaser sequel).
- DLC : dans le passe, P ne peut ni sauver Romeo ni Lea, mais altere plusieurs destinee mineures.
...
FIN_WIKI_PERSONNAGES_PINOCCHIO
