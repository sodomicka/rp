...
- Avant l'arrivee des Alchimistes, les stalkers etaient les gardes des old families (caretakers et privilegies qui dirigeaient Krat depuis des generations). Le pouvoir des old families decline avec l'arrivee des Alchimistes et du Workshop Union.
...
- Leur pouvoir decline avec l'arrivee des Alchimistes et du Workshop.
- La famille Wolf finance les labs des Alchimistes.
- La famille V impliquee dans le meurtre d'ouvriers de la Relic.

### Battle of the Workshop Tower

- Le Workshop Tower = lieu de travail de Geppetto et des artisans qualifies du Workshop Union.
- Les stalkers (des deux factions) arrivent pour eliminer les pantins de la Puppet Frenzy qui attaquent les habitants.
- Enormes shards de Crowd erumpent du sol -> effondrement de la tour. Nombreux morts.
- Tant de stalkers morts que beaucoup les considerent extermines.
...
- Red Fox (Claudia) est une bastard stalker de la maison Wolf.
- La famille Wolf finance la construction du lab des Alchimistes avec d'autres familles nobles.
- Certaines familles nobles demandent des informations sur les labs (les Zelator Facility sous l'Hotel Krat) -- signe que tout le monde ne savait pas ce qui s'y passait.
