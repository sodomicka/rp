...
- Sophia_Monad.md (W2) - Listener / "Fee bleue" ; fille de Valentinus ; guide P ; prisonniere de Simon.
- Gemini.md (W1) - grillon-lanterne ; guide permanent de P.
- Romeo.md (W5) - King of Puppets ; ami d'enfance de Carlo ; meneur de la revolte des pantins.
...
- Lea_Florence_Monad.md (W5) - Legendary Stalker ; mentor de Carlo et Romeo ; traque Arlecchino.
- Arlecchino.md (W2) - pantin meurtrier (DLC) ; "l'Artiste de sang" (1850) puis "Roi des Enigmes" (1852) ; vengeance contre Lea.
- Markiona.md (W8) - alchimiste, la Marionnettiste de la Mort ; typologie des Pantins de l'Arc ; son Magnum Opus = Magnus.
- Magnus.md (W5) - [OC] pantin parfait ne du Coeur de l'Arc (cristal d'Ergo emeraude), indiscernable d'un humain, Ego inne ; Magnum Opus de Markiona.
...
- Lumacchio.md (W2) - chef des Bastards ; traitre au service de Simon.
- Veronique.md (W4) - cheffe des Sweepers ; piegee par les Alchimistes.
...
- PNJ_secondaires.md (W4) - fiche groupee (Belle, Julian/Melody, the Atoned, Klaus, Hugo, Godard, Colonel Little/Rex, Luca, Subject 826, Columbo, Dorothy, Decart, Cassius).

### Creatures/
Description : boss et creatures notables.
- Boss_et_Creatures.md (W2) - fiche groupee (Parade Master, Scrapped Watchman/Murphy, Fuoco, Mad Donkey, King of Puppets, Walker of Illusions, Champion Victor, Green Monster of the Swamp, Anguished Guardian, Two-Faced Overseer, Tyrant Predator, Nameless Puppet, Door Guardian, Ange de l'Arc reforge).
...
- Les_Stalkers.md (W3) - Bastards vs Sweepers ; Stargazers ; Battle of the Workshop Tower.
...
- Objets_et_Reliques.md (W2) - fiche groupee (P-Organ, Golden Ergo, Ergo Wavelength Decoder, Stars Chrysalis, Rose Sword, Holy Mark, Gold Coin Fruit, Broche Monad, Daylight-Wreathed Horn, Ouroboros Eye, portrait de Carlo, Saintess of Mercy, pendentif de Carlo).
...
> ROADMAPS (par arc) : Roadmap_01_Eveil (Ere 1, R1), Roadmap_02_Les_Loups (Ere 2, R1) et Roadmap_03_Overture (Ere 3, R1) PRODUITES. NON indexees (sources de build, v8.2 : jamais fetchees en jeu ; se lisent en listant LOP/Roadmap/Magnus/). Roadmaps Eres 4-5 a produire ensuite.
> FICHES D'ARC / CODEX : pas encore produits comme livrables dedies (Passe 3).
> Statut Passe 2 (boucle serree) : Eres 1 (1847), 2 (1848-1850) et 3 (Overture, 1850) DETAILLEES et CLOTUREES cote fiches ; roadmaps : Eres 1-3 produites ; Eres 4-5 a forer.
> L'echafaudage des eres vit dans Chronologie.md (Documents de travail, C5, allegee : Eres 1-3 -> roadmaps) ; les Fiches_Arc/ et le CODEX viendront en Passe 3.
