...
> - EN NARRATION, a chaque page fetchee : le MJ compare le `W<N>` de la page au `W<N>` de son entree au Sommaire. Ecart -> `[VERSION DECALEE - <page> : Sommaire W<x>, page W<y>]` en OOC bref, NON BLOQUANT. La PAGE fait foi.
...
> MEMOIRES NON INDEXEES. `Parties/<Partie>/Memoires/` : archives narratives cumulatives, interdites en jeu (sauf ordre OOC explicite), consultees au BUILD par listing direct.

## PARTIES (Partie1)
(Aucune partie en cours - dossiers a creer au premier CODEX BUILD.)
