...
- Soul_Society.md (W1) - Seireitei, Rukongai, societe, acces
- Monde_des_Vivants.md (W1) - Karakura, jureichi, ames errantes, calage temporel
- Hueco_Mundo.md (W1) - desert des Hollows, foret des Menos, Las Noches
- Dimensions_Annexes.md (W1) - Dangai, Garganta, Palais Royal, Enfer (Konso Reisai)

### Systemes/
Description : regles des pouvoirs et mecaniques du monde.
- Ames_et_Reiatsu.md (W2) - konpaku, cycle des ames, reiryoku/reiatsu, gigai (seul camouflage complet du reiatsu [DIVERGENCE RP])
- Zanpakuto.md (W1) - asauchi, shikai, bankai, esprits, lames jumelles
- Kido_et_Disciplines.md (W1) - zankensoki, hado/bakudo, shunpo, shunko
- Hollows_et_Hollowification.md (W2) - evolution Hollow, arrancar, Vizards, Hollow interieur, domptage (Jinzen, trois methodes)
- Quincy.md (W1) - destruction d'ames, blut, schrift, Auswahlen, medaillons
- Fullbring.md (W1) - origine Hollow prenatale, Xcution, parallele Vizards

### Factions/
Description : groupes, institutions et armees.
- Gotei_13.md (W1) - structure, co-capitainat [DIVERGENCE RP], compositions par ere
...
- Vizards.md (W3) - les 9 hollowifies [DIVERGENCE RP], exil, jalons de groupe, retours
...
- Mashiro_Kuna.md (W4) - lieutenante 9e, combat aux pieds, zanpakuto non montre
- Rojuro_Otoribashi.md (W4) - capitaine 3e (Rose), Kinshara (bankai Kinshara Butodan)
- Love_Aikawa.md (W3) - capitaine 7e, Tengumaru
- Hachigen_Ushoda.md (W4) - vice-capitaine du Corps de Kido, barrieres
