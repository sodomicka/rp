...
## Identite
- Nom complet : Kyoraku no Jiro Sakuranosuke Shunsui (anciennes romanisations : Sozosuke). Second fils de la haute famille noble Kyoraku.
- Statut : capitaine de la 8e division ; co-capitaine aux cotes de son epouse Kasumi depuis ~-350 [DIVERGENCE RP].
- Age : dans son 14e siecle a l'ere Kurosaki (ne entre ~-1400 et ~-1300), comme Kasumi et Ukitake [DIVERGENCE RP].
...
## Aptitudes
- L'un des tout premiers sabres du Seireitei. Ambidextre : alterne et equilibre la force entre ses deux lames pour surprendre l'adversaire.
- Lecture du reiatsu excellente : l'instrument de la surveillance discrete du couple [DIVERGENCE RP].
- L'egal de Kasumi, en combat comme en flemme [DIVERGENCE RP]. La chasse au Vasto Lorde (~-350) sert d'etalon de puissance au duo. Puissance largement cachee au Seireitei [IMPLICITE].

## Katen Kyokotsu
- L'une des rares paires de lames du Seireitei (deux sabres scelles, portes en daisho).
- Esprit double : deux femmes.
- Shikai : les jeux d'enfants deviennent reels et leurs regles s'imposent aux deux combattants, Shunsui compris. Jeux connus : Bushogoma (toupies de vent), Kageoni (les ombres attaquent), Takaoni (le plus haut place gagne), Irooni (on ne coupe que la couleur annoncee, degats et risques proportionnels), Daruma-san ga koronda.
- Bankai : Karamatsu Shinju. Impose un drame en quatre actes au duel : partage des blessures infligees (Tameraikizu no Wakachiai), honte qui ronge (Zanki no Shitone), noyade mutuelle (Dangyo no Fuchi), fil tranche qui acheve (Itokiribasami Chizome no Nodobue).
- Contrainte : Shunsui ne libere jamais son bankai devant des allies - son drame ne les distingue pas.

## Relations
- Kasumi Kyoraku : epouse [DIVERGENCE RP]. Couple fusionnel, plus vieux couple du Seireitei. detail : cf. WIKI Personnages/Kasumi_Kyoraku.md
- Jushiro Ukitake : meilleur ami, d'enfance (anterieur a l'academie [DIVERGENCE RP]). Dans la confidence de Mimihagi.
...
| -101 -> 0 | Un siecle sans nouvelles ; enquete cote Seireitei avec Ukitake (la moitie du dossier ouverte au proces) ; aux soirees entre anciens, recoit d'un Genryusai ivre son doute sur le mot "trahison" | La culpabilite s'use sans se solder ; le dossier avance |
