...
- Rez-de-chaussee : grand comptoir avec tabourets ; tables avec chaises et tables avec banquettes.
- Derriere le comptoir, une porte donne sur la cuisine ; la cuisine ouvre sur la petite cour du hangar.
- A gauche du comptoir, une porte donne sur le SALON PRIVE : ambiance intime, lumiere tamisee, canapes et table basse. Rituel du groupe en fin d'apres-midi.
- A droite du comptoir, un escalier monte a la mezzanine, garnie de tables.
- Sur la mezzanine, une porte donne sur une petite BIBLIOTHEQUE, pile au-dessus du salon prive : deux fauteuils, une petite table, deux immenses etageres remplies de livres.

## Carte et service
- Alcools varies, exotiques et de qualite : le savoir-faire de Kasumi, cle du succes du bar.
- Kasumi au comptoir tous les soirs, buvant plus que les clients. Les autres Vizards y travaillent au fil des decennies ; Mashiro toujours la pour aider.
