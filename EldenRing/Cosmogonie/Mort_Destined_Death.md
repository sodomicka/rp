...
- Retiree du Ring par Marika a son avenement [etabli].
- Confiee a Maliketh, la Black Blade, ombre de Marika, qui la scelle en lui [etabli].
- Consequence : la Destined Death (mort veritable) quitte l'ordre du monde [etabli].

## L'ordre sans la mort
- Sous l'Ordre d'Or, les ames des morts retournent a l'Erdtree et reviennent a la vie [etabli].
- La mort veritable devient exterieure a la loi : mourir vraiment n'est plus prevu par le Ring [etabli].
- Tranchage : la Mort etait le principe organisateur de l'ere precedente, portee par la GEQ [CANON LOCAL CL-01].
...
- Deathbirds : gardiennes des feux funeraires, servantes de la Mort [etabli].
- Le twinbird est leur mere et l'envoye d'un dieu exterieur [etabli] (cf. Cosmogonie/Outer_Gods.md).

## Tranchages lies (cf. Conventions.md)
...
FIN_WIKI_COSMOGONIE_MORT_DESTINED_DEATH
