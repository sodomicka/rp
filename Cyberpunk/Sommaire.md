...
- Night_City_2077.md (W5) - cadre politique, corpos, districts et gangs, fixers, colonne vertebrale canon de V
...
- Pacifica_et_Dogtown.md (W5) - Pacifica, Coastview, Batty's Hotel, Grand Imperial Mall (vide au point de depart), ancien commissariat NCPD (base de Dodger), Dogtown, Black Sapphire, Eventide Resort & Spa (planque discrete, theatre de R1), Luxor High Wellness Spa, Cynosure
- Watson.md (W6) - district, bouclage NCPD (R0 et R1, leve apres le braquage), Northside, All Foods, Totentanz, Kabuki, Little China, contrats Regina Jones
- Sites_Arasaka.md (W4) - Konpeki Plaza et le braquage (T0 = J4, fin avril-debut mai 2077 ; Silas en assurance de T-Bug depuis l'Eventide), Mikoshi et Soulkiller

### Chronologie/
Description : chronologie condensee de l'univers et colonne vertebrale de 2077.
- Chrono_Univers.md (W6) - 1990-2076, fondation, DataKrash, Blackwall, Haiti, Unification, Dogtown, Silas, percee 2075
- Chrono_2077_Acte1.md (W1) - premiere moitie de l'annee : etat du monde a l'ouverture de R0 (point de depart, J0 = soir de The Rescue), R0 en trois jalons, calage J1 (Dex recrute) - J2 (appel de T-Bug) - J4 (T0) - J11 (appel a Rogue), R1 et le Konpeki depuis l'Eventide, ellipse de 3 semaines (mort de Rhyne, venue et traque de Lilith, arrivee de Mosley et des Animals au Mall)
- Chrono_2077.md (W12) - suite de l'annee, sections S3 a S6 : acte 2 de V (ligne Voodoo Boys, branche du RP), Phantom Liberty, fins, lecture d'ensemble ; renvoie a Chrono_2077_Acte1.md pour l'acte 1 et l'ellipse
...
- Silas_Null.md (W8) - PROTAGONISTE : identite, nom et handle Zer0, physique, personnalite, histoire jusqu'au point de depart, domiciles, chrome, capacites, echelles et signature violette, symbiose, metier, langue et lexique creole
- Silas_Null_relations_1.md (W3) - satellite : Yor, Slider, Brigitte, Placide (surnoms, rituels, dynamique, ce que l'autre sait)
- Silas_Null_relations_2.md (W5) - satellite : T-Bug, Mr. Hands, Rogue, Regina Jones ; evolutions datees R0, R1
...
- T_Bug.md (W3) - netrunneuse merc, profil, Rhino et Coastview, Dex, V et Jackie, The Rescue, lien a Silas ; trajectoire R1 : appel a Silas, Konpeki, engramme copie, trait plat
...
- V.md (W4) - merc, femme, Gosse des rues, divergence Valentinos (Jackie grand frere), look promo, Sandevistan sans deck, etat au point de depart (The Rescue) ; trajectoire : J1 (Dex), T0 (Konpeki, Relic)
- Mr_Blue_Eyes.md (W2) - IA en corps proxy, reseau d'esclaves, agents aux yeux bleus, instruments, concurrent de Yor
- Peralez.md (W4) - le couple, bourse Night Corp, election, Rhyne (maire en exercice, mort pendant l'ellipse), SSI, cobayes de Blue Eyes
- Sandra_Dorsett.md (W3) - netrunneuse Night Corp, Operation Carpe Noctem (CN-07), The Rescue (au point de depart), databank perdu
...
- Rogue_Amendiares.md (W1) - reine de l'Afterlife, ex-solo de legende, meilleure fixer de Night City, Johnny Silverhand, raids de 2013 et 2023 sur l'Arasaka Tower, fixer occasionnelle de Silas ; trajectoire R1 (Silas se dit disponible)

### Power_Scaling/
Description : echelles de puissance, etat au point de depart, deltas dates alimentes a chaud. Passe 1, lot livre.
- Scaling_Numerique.md (W2) - entites sur trois axes (planification, taille, puissance brute) et etalons, Blackwall au sommet, netrunners par paliers, talent et specialite ; deltas dates (R1)
