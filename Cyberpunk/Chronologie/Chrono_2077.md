...
- [DIVERGENCE RP] Silas est branche cette nuit-la. Point de depart du RP. Ce qu'il y fait : roadmap, Passe 2.
...
- Fenetre Watson / Northside : Regina Jones, Cyberpsycho Sightings, "Bloody Ritual" (rituel Maelstrom, Lilith, Zaria Hughes), "The Prophet's Song" (Gary, reunion Arasaka / Maelstrom, "Carpe Noctem"). [DIVERGENCE RP] Contrat de Silas a Northside : ARC LILITH.
...
- Ligne Voodoo Boys (Pacifica) : Mr. Hands, Placide, piege NetWatch au Grand Imperial Mall, Bryce Mosley, plongee sous la chapelle avec Brigitte, rencontre d'Alt, netrunners VDB grilles. Bifurcation canon : V epargne ou tue Brigitte et Placide [etat par defaut a fixer en roadmap]. [DIVERGENCE RP] ARC ALT ET VDB.
...
- [DIVERGENCE RP] ARC BLUE EYES, puis LE MUR. Sort de V par defaut : oriente Crystal Palace / manipulation par Blue Eyes, tranche en fin de roadmap.

## 6. Lecture d'ensemble
- Ordre des arcs de Silas : R0 intro (contrat Hands) -> R1 Konpeki (T0) -> Lilith (Northside) -> Alt et VDB (Pacifica) -> Songbird (Dogtown) -> Blue Eyes (Night Corp, Crystal Palace) -> le Blackwall.
- Deux predateurs d'IA courent en parallele toute l'annee : J0RMUN94ND (amalgame) et Blue Eyes (reseau d'esclaves). Points de collision : Songbird, puis le mur.
