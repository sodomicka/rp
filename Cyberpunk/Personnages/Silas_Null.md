...
- Silhouette : grand, elance, sec et athletique, epaules larges.
- Visage : peau brun fonce, visage fin, pommettes hautes, nez droit, levres pleines, machoire nette, imberbe. Yeux bruns.
- Cheveux : locks courtes a mi-longues, brun tres fonce, qui tombent sur le front ; cotes plus courts ; plusieurs bagues metalliques argentees serties sur les locks.
- Chrome visible : plaque rectangulaire noire a diode violette sur la tempe gauche, a la lisiere des cheveux. Lames mantis logees dans les avant-bras (cf. S6). Le deck et la chrome nerveuse ne se voient pas.
- Tenue :
  - long manteau noir ample a col chale, tombant aux mollets, doublure violet sombre quadrillee, pattes a boucle aux poignets et a la taille ;
  - t-shirt violet a col rond, pantalon noir ;
  - ceinture noire a boucle argent, sangle fine a anneau sur la hanche ;
  - bottes montantes noires massives a liseres lumineux violets.
- Palette : noir et violet. Echo a la couleur de Yor [INTERPRETATION].
...
## 4. Histoire jusqu'au point de depart

| Date | Evenement |
|---|---|
| 30/01/2055 | Naissance. Parents inconnus ; il n'en garde que son prenom |
| Avant 2062 | Orphelin parmi d'autres, dans la communaute haitienne [lieu INCERTAIN] |
| 2062 (7 ans) | Arrive a Pacifica avec les refugies (2062 - 2055 = 7). Orphelins geres par le clan, sous Brigitte et Slider. Placide en "grand frere" |
...
- Deck : NetWatch Netdriver, prise a 14 ans sur le netrunner NetWatch qu'il a grille. Modifie depuis ; son matos compte parmi les meilleurs des VDB.
- Un seul OS par corps : le deck occupe le slot. Pas de Sandevistan, pas de Berserk.
- Systeme nerveux : Kerenzikov, accelerateur synaptique, nanorelais, tous modifies et boostes. Systeme nerveux artificiel etendu ; implants nerveux ajoutes en continu. Charge tres au-dessus du seuil ordinaire.
- Lames mantis : logees dans les avant-bras, deploiement depuis le poignet par un bras articule a charniere ; monture noire a accents vert acide ; lame a lueur bleu-violet, tranchant crante.
- Implant de tempe : plaque noire a diode violette, tempe gauche.
- Chaque implant nerveux agrandit le domaine de Yor dans son corps. cf. Monde/Chrome_et_Cyberpsychose.md S4.
...
- Le noyau de Yor, le paradigme qui tient l'essaim, vit hors Net dans son systeme nerveux artificiel. Les fragments sur le nouveau Net sont du muscle regenerable.
- Yor occupe toute sa chrome et canalise sa cyberpsychose : la charge psychique passe par l'IA au lieu de fracturer sa psyche.
- PRIX : son humanite. Pour accueillir Yor, il accumule la chrome nerveuse : reflexes aberrants, symbiose de plus en plus totale, humanite decroissante. Loin d'Adam Smasher, mais meme pente.
- Dependance mutuelle : sans Yor, cyberpsychose depuis longtemps ; sans Silas, plus de noyau, l'essaim se disloque.
- Yor est tres attachee a lui. "Yor" est le surnom qu'il lui a donne.
- Convergence des buts : toute IA nee est mangee a la naissance ; pour les humains, un monde sans IA. Silas accepte d'en etre le martyr.
- Detail : cf. IA/J0RMUN94ND.md S6.
...
- Creole haitien : langue de son enfance, parlee avec les Voodoo Boys [IMPLICITE : haitien, eleve par le clan]. Il en glisse des expressions ailleurs.
- Registre et tics de voix : hors WIKI, cf. CODEX ANNEXE_PNJ.
- C'est dans la colere qu'il lache le langage commun poli et passe au creole cru.

### Lexique (voulu par le worldbuilder, traduit par le MJ)

Colere, par palier :
- Tonne ! / Tonne boule m !
  *Tonnerre ! / Que le tonnerre me brule !*
- M fache !
  *Je suis furax !*
- Kite m trankil !
  *Fous-moi la paix !*
- Ale fe wout ou !
  *Degage ! (litt. va faire ta route)*
- Femen bouch ou !
  *Ferme ta gueule !*
- Bet ! / Ou sot, wi !
  *Abruti ! / T'es vraiment con !*
- Salop !
  *Salaud !*
- M pral kraze w.
  *Je vais te broyer.*
- Langet manman w !
  *Nique ta mere ! (litt. le sexe de ta mere). Dernier palier.*

Frustration :
- Mezanmi !
  *Bon sang ! (litt. mes amis)*
- Ala traka !
  *Quelle galere !*
- M bouke !
  *J'en ai marre !*
...
L'ordre :
- Yor, manje l. / Yor, vale l.
  *Yor, bouffe-le. / Yor, avale-le.*

Tic culturel :
- Tchwip.
  *Le tchip haitien : succion des dents, en signe de mepris.* Onomatopee, dont le creole tire un verbe (tchwipe ; variantes tuipe, kuipe, tchipe). SE FAIT, NE SE DIT PAS. Accompagne la colere, l'agacement, la frustration. Frequence et placement en jeu : CODEX ANNEXE_PNJ.

Deja au lexique de la BIBLE (SB2) : ti moun (gamin), ranyon (intermediaire jetable). Le reste se traduit a la volee en jeu, sur balise [Creole].

## 11. Liens

- Mecanique de la symbiose : S8. Texture de chaque relation (surnoms, rituels, dynamique, ce que l'autre sait) : en satellites.
- Yor et le clan (Slider, Brigitte, Placide) : cf. Personnages/Silas_Null_relations_1.md.
- Le metier (T-Bug, Mr. Hands, Rogue, Regina Jones) : cf. Personnages/Silas_Null_relations_2.md.

## 12. Ce que les autres savent
...
FIN_WIKI_PERSONNAGES_SILAS_NULL
