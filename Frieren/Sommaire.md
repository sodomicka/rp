...
- Societe_Et_Plan_Du_Roi.md - nomades, pas d'enseignement, quotidien, evolution forcee, Schein comme specimen

### Personnages/
Description : fiches personnages cles et rapports detailles avec Schein.
- Frieren_Fiche.md - identite, personnalite, capacites, limites, backstory
- Frieren_Rapport_Schein.md - massacre, reputation, guerison, chasse, hutte, ere Himmel, Aeusserst
- Serie_Fiche.md - identite, personnalite, capacites, rapport Flamme
- Serie_Rapport_Schein.md - rencontre, 150 ans, rupture, miroir, silence, Tchekhov Aeusserst, rapport Frieren (triangle)
- Roi_Des_Demons.md - identite, personnalite, capacites, plan, rapport Schein (tortures, exil, combat final), relations autres
- Schlacht.md - identite, prescience, prediction, titre de prince, rapport Schein, miroir Heros du Sud, plan de survie
- Macht.md - identite, Diagoldze, arc de Weise, curiosite envers Schein, bras dore de Frieren
- Flamme.md - identite, personnalite, capacites, backstory, rapport Schein (reputation croisee, hesitation, double miroir thematique)
- Heros_Du_Sud.md - identite, personnalite, capacites, backstory canon, rapport Schein (visite hutte, message, prescience floue)
- Himmel.md - identite, backstory, capacites, episode demon-enfant, charmeur taquin, bague de lotus, Aeusserst, renoncement, statues, journal, post-quete et mort
- Eisen.md - identite, personnalite, capacites, backstory, rapport Schein (acceptation, flanc gauche, matchmaking, miroir peur/orgueil)
...
- Revolte_Le_Divin.md - general demon quadri-arme de l'arc Revolte le Divin (canon), Epees Divines Trancheuses, subjugation a Rufen (Ere 5), divergences RP par branche (recul de Schein 5a / execution par Schein 5b), sbires (Hemmung, Solide, Jung), mort dans les deux branches
...
- Uebel.md - identite, Reelseiden, copie par empathie, rapport Schein (attraction instinctive, miroir)
...
- Norm.md - marchand-seigneur, lignee Norm / Graf Dach [DIVERGENCE RP - FUSION], pret + epee hereditaire, rapport Schein (lore fierte demoniaque)
...
- Roadmap_Serie_01_Premier_Contact.md - Ere Serie (~890-740 av.) : rencontre, apprivoisement maladroit, 150 ans de couple conflictuel, suppression de mana, village elfe de Serie, rupture
- Roadmap_Chasse_Solo.md - Ere solitaire (~740-590 av.) : guerilla par amour pour Serie, village gentil / village brule, retour definitif a la vulgarite, rencontre Frieren, guerison bras dore
...
- Roadmap_Himmel_05_Retour.md - Chateau -> Hutte (An 10-15, voyage retour et separation du groupe)
...
- Roadmap_Frieren_02_Plateau_Nord.md - Plateau Nord post-Aeusserst (An ~96-97, Ere 5, branche 5a) : sortie d'Aeusserst -> Graf Dach (dette de Himmel rendue) -> Lac Korridor (monastere de l'ile, journal de Himmel) -> Tor (Gehen) -> Fabel -> Rufen (Revolte le Divin, sbire de la brume Hemmung, enfant-leurre Jung) -> seuil de Weise
