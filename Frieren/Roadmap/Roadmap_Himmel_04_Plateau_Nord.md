# Roadmap Himmel - 04 Plateau Nord
...
- **Periode estimee** : An ~8.
- **Statut** : canon (lieu). Invention (evenement).
- **Evenements** :
 - Le groupe est coince en attendant un bateau. Seul point de passage vers le haut plateau.
 - Attente forcee. Moment de pause dans l'acceleration vers Ende.
- **Personnages impliques** : groupe.
- **Role de Schein** : patience forcee. Un demon predateur bloque par un lac et l'absence d'un bateau. Contraste comique ou contemplatif.
- **Tchekhov** : -
- **Notes** : -
...
- **Periode estimee** : An ~8.
- **Statut** : canon (rencontre avec Gehen, financement du pont par Himmel).
- **Evenements** :
 - Le groupe arrive au Grand Canyon de Tor. Impossible de le traverser - vents violents, 3 km de profondeur.
 - Ils trouvent Gehen, nain dont le village a ete detruit par des demons. Il construit un pont pour que les soldats puissent traverser a l'avenir et proteger les villages.
 - Gehen manque de fonds. Himmel lui donne la recompense de Graf Dach.
 - Gehen hesite - Himmel sera mort avant que le pont soit fini (200 ans de construction). Himmel insiste : Frieren recuperera la recompense en son nom. Il demande a Gehen de construire un pont qui tienne mille ans, pour les generations futures et ses compagnons millenaires.
- **Personnages impliques** : Gehen, Himmel, Frieren, Schein, Eisen, Heiter.
...
- **Statut** : invention.
- **Evenements** :
 - Nombreuses forets enneigees et villages entre le Canyon de Tor et Ende.
 - Monstres et demons de plus en plus puissants a mesure que le groupe approche du territoire du Roi.
 - Progression difficile. Le groupe est rode mais la resistance augmente.
- **Personnages impliques** : groupe, demons mineurs (non nommes).
- **Role de Schein** : en territoire familier. Les Terres du Nord proches d'Ende, c'est son ancien terrain de vie. Ses instincts de predateur et sa connaissance du terrain deviennent des atouts tactiques.
- **Tchekhov** : -
- **Notes** : Zone non detaillee etape par etape. Le joueur a note " nombreuses forets enneigees et villages, monstres et demons puissants ". A detailler si besoin lors du RP.
...
- **Evenements** :
 ...
 - Solitaer traque la source et organise l'embuscade. Recrute Grausam, Rivale et Tot. Tot refuse de participer et part.
 - Frieren de l'ere Fern est projetee dans le corps de la Frieren de l'ere Himmel. Elle possede ses souvenirs du futur.
 - Zart (serviteur de Grausam) attaque en premier - teleporte Frieren dans le ciel. Frieren riposte avec des sorts du futur (vol, puissance brute). Zart elimine.
 - Grausam lance Ansehelschella sur Himmel, Heiter et Frieren. Reve : Himmel et Frieren se marient (Voll est invite dans le reve).
 - Heiter resiste grace a la Grace Divine.
 - Himmel, prisonnier de l'illusion, combat a l'aveugle - tranche le bras de Grausam, brise le sort, localise Solitaer par la trajectoire de ses lames.
 - Solitaer ordonne la retraite.
 - Schein demande d'epargner Solitaer. Motif : dette passee. Solitaer etait l'un des rares demons a ne pas etre hostile envers lui au chateau. Schein promet de la tuer plus tard si elle s'en prend a des humains.
...
- **Periode estimee** : An ~8-9 (apres le Monument, avant le Chateau).
- **Statut** : divergence (role de Schein). Canon (mort de Grausam par le Groupe des Heros).
- **Evenements** :
 - Le Groupe des Heros confronte Grausam quelque part sur le Plateau Nord.
 - Schein reste en retrait - par egard pour son ancien mentor au chateau.
 - Le groupe porte le coup. Grausam est tue collectivement.
 - Dernier echange : Grausam remercie Schein pour sa consideration. Sincerite ou manipulation - impossible a trancher. Le dernier geste de Grausam est aussi illisible que tous les autres.
...
- **Type** : champ de bataille.
- **Periode estimee** : An ~9-10.
- **Statut** : invention.
- **Evenements** :
 - Combat contre une escouade lourde de demons. Derniere ligne de defense avant le Chateau du Roi.
 - Le groupe est a pleine puissance, rode par dix ans de quete.
...
- **Periode estimee** : An 10.
- **Statut** : canon (mort du Roi des Demons). Divergence (role de Schein).
- **Evenements** :
 - Arrivee au chateau du Roi des Demons. Ende. Dix ans de voyage.
 - Combat final contre le Roi des Demons (~5 700 ans, S+ tier).
 - BIBLE SB3 : " deux lames, un seul coup. Bras libere. "
 - Le Roi est tue. Schein et Himmel portent le coup final ensemble.
 - Le sceau du Roi sur le bras gauche de Schein se brise avec la mort de son createur. Le bras est libere apres un millenaire.
 - Mort du Roi = fin du Royaume Demon. Les Sages restants sont dissous. Ende n'est plus verrouille.
- **Personnages impliques** : Roi des Demons, Schein, Himmel, Frieren, Eisen, Heiter.
- **Role de Schein** : culmination de tout. Le fils tue le pere. Le cobaye detruit le chercheur. Le prince exile reprend ce qu'on lui a pris. Le bras libere est le symbole physique de la liberation - un millenaire de scellement, termine en un instant. Cf. Personnages/Roi_Des_Demons.
- **Tchekhov** :
...
FIN_WIKI_ROADMAP_HIMMEL_04_PLATEAU_NORD
