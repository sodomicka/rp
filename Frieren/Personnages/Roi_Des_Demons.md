...
- Nom : inconnu. Titre : Roi des Demons.
- Espece : demon.
...
- Detection de mana exceptionnelle : a immediatement repere que Frieren supprimait son mana quand ils se sont rencontres. Seul demon connu a l'avoir fait.
- Double specialisation magique [DIVERGENCE RP] : domination (sorts de controle et de communication pour les ordres majeurs, maintien de la loyaute sur toute l'espece) et magie destructrice (espadon, Zoltraak, sorts offensifs puissants au combat).
- Le sceau sur le bras de Schein tient un millenaire — preuve de puissance ecrasante.
...
**Recueil (~1 490 av.).** Demons mineurs amenent Schein enfant (~100 ans). Schlacht previent que le garder causera la chute du Roi. Le Roi ignore — la curiosite du chercheur ecrase le calcul du souverain.
...
- **Schlacht** : conseiller, prescience millenaire. Relation fonctionnelle. Le seul etre que le Roi consulte. Sa mort (~50 av. An 0, Heros du Sud) prive le Roi de son devin.
- **Solitaer** : le Roi lui a enseigne l'evolution convergente. Relation intellectuelle entre chercheurs.
- **Macht** : partage le meme desir de coexistence. Schlacht a manipule Macht pour le combat contre le Heros du Sud.
- **Les Sept Sages** : loyaute maintenue par la hierarchie de mana et la domination.

---

FIN_WIKI_PERSONNAGES_ROI_DES_DEMONS
