...
- Regle de page : seules les valeurs sourcees (fiche officielle LN, comparatif de l'auteur,
  decision worldbuilder) sont inscrites. Une entite sans valeur sourcee n'est pas chiffree.
- ETAT DECRIT : le jour 0. Les variations posterieures vivent en Trajectoire datee de la
  fiche concernee, pas ici.
...
- Niv. 30-40 : domaine des heros. Legendes vivantes. Les Trois Monstres de la foret de Tob
  - le Roi Sage, Guu, Ryraryus - se tiennent au seuil de cette bande : ~30, estimation
  (decision worldbuilder).
- Niv. 40-60 : anomalies. Monstres anciens, demi-dieux locaux.
- Niv. 60+ : quasi exclusivement lie a Yggdrasil (Joueurs, leurs creations, leurs
  reliquats). Ancre native : Zesshi Zetsumei, 88 (somme de la fiche officielle, LN vol. 16),
  Siege hors rang de la Theocratie - la seule native chiffree a cette hauteur ; sous les
  Gardiens de Nazarick, au-dessus de toute Pleiade.
...
## Echelle interne de Nazarick [DIVERGENCE RP]
...
- L'echelle mesure la POLYVALENCE. Le duel pur est une affaire de specialite et peut
  renverser un palier sans le contredire : Shalltear > Albedo en duel pur ; Mare, deuxieme
  Gardien en duel au classement canon, reste palier 5 car bien moins polyvalent.
...
Le tresor ne se renouvelant plus, la depense reste definitive (cf.
Nazarick/Regles_Internes.md). Detail : cf. Personnages/Shalltear.md.
...
## Renvois
- Rangs de sorts et plafonds : cf. Magie.md. Grande magie :
  cf. Grande_Magie_et_Signatures.md.
- Arts Martiaux, Talents : cf. Systemes_Natifs.md.
- Niveaux, races, karma, transferts : cf. Yggdrasil.md.
- Fiches individuelles : cf. Personnages/.
