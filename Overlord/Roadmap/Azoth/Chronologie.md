...
- convention de nommage (actee R1-R3) : l'ETAT DU BERGER, titre d'Azoth dans l'arc.
  R4+ : nommage [A POSER] au decoupage.
...
- J0 = minuit 2138, transfert de Nazarick. Toute date en jours depuis J0. La Timeline
  fandom compte "1st day" = jour du transfert : conversion J = jour source - 1,
  appliquee partout.
- Ancres canon converties : renommage Ainz Ooal Gown et bataille de Carne J3 ; Momon a
  E-Rantel ~J8 ; frappe de la Chute sur Shalltear J10 ; mort et resurrection de
  Shalltear J12 ; campagne des hommes-lezards J27-J36 ; conseil de guerre de Re-Estize
  ~6 mois. Au-dela, le canon ne date plus rien : positions RELATIVES par tome (LN 9 a
  LN 16).
- Office de l'Eglise Impie : HEBDOMADAIRE (acte). J0 et J7 en cycle ; J11 sermon
  d'urgence hors cycle.
...
- Bornes relatives : apres J12 -> mariage d'Albedo et d'Azoth (apres J36, juste avant
  l'arc du royaume des nains - creneau LN 10/11, donc apres la fondation du Royaume
  Sorcier).
- Jalons : seances avec les Pleiades ; conquete du coeur d'Albedo, fiancailles ; J36
  premiere des deux sorties - resurrection des trois hommes-lezards tombes face a
  Cocytus [DIVERGENCE - officiant et perimetre : canon = Zaryusu seul, par Ainz] ;
  quiproquo de l'HERESIE D'AZOTH (doctrine d'autonomie : les 41 doivent mourir
  conceptuellement - idee actee, formulation a retravailler au build), tentative de
  meurtre par Albedo, revelation complete ; jours de digestion puis acceptation,
  MARIAGE le jour meme (Tchekhov SB8 du parametre solde) ; union tres libre ; debut de
  la CHASSE AUX TRACES DES SUPREMES dans le dos d'Ainz - en faire le seul maitre,
  prets a tuer leurs propres createurs (ironie joueur -> CODEX) ; continue au-dela du
  bloc.
- Element central : Albedo - de l'ecriture au choix.
- Fichier : [A POSER au decoupage]
- [A POSER] : decoupage interne du bloc ; datation relative fine (fiancailles,
  quiproquo) ; haine des Quarante chez Albedo (ampleur, forme - declencheur solde) ;
  premiers resultats de la chasse et lien au mystere SB8 du sort des 40.

## R5 - La greffe de Slane [BLOC - DECOUPAGE A POSER]

- Position : apres la fondation du Royaume Sorcier, au creneau canon des LN 15-16
  (guerre de la Theocratie contre le Pays des Elfes). Canon LN 11 -> 14 par defaut
  entre R4 et R5.
- Jalons : toile de fond canon conservee - gros des troupes de Slane chez les elfes,
  Zesshi tue son pere Decem ; Azoth envoye SEUL aneantir l'armee en partance de sa
  campagne - seconde et derniere sortie hors Nazarick ; attaque de zone, Zesshi seule
  survivante ; "La Mort nous fauchera Tous" [VF ACTEE], heritage de Surshana, encaisse
  a 100 % [DIVERGENCE systeme - pure Energie Negative, a inscrire a Magie.md] ;
  REMPLACE le combat canon Mare contre Antilene ; Zesshi eperdue, ramenee a Nazarick ;
  plan a trois avec Albedo, attachement des deux femmes, MARIAGE A TROIS par la
  suite ; Slane non aneantie : CAPITULATION/VASSALITE offerte, style Baharuth.
- Element central : Zesshi - et la Theocratie mise a genoux.
- Fichier : [A POSER au decoupage]
- [A POSER] : casus de l'envoi d'Azoth ; ou et quand Azoth "a vu" Ainz user du sort ;
  sort de la revelation canon "la Theocratie a lave le cerveau de Shalltear" ; vacance
  canon d'Ainz, Aura et Mare maintenue en parallele ou non ; devenir du Pays des
  Elfes ; datation relative du mariage a trois.

## R6+ - [OUVERT]

- "Pas d'autres plans sur la trame principale" (worldbuilder). La suite appartient a
  l'histoire des autres et aux arcs secondaires.

## Raccords parques (hors blocs, en attente d'arc)

- SEBAS ET TUARE : aucun desir avant elle (rencontre au creneau canon LN 5-6) ; Azoth
  les mariera [fenetre a poser].
- SOLUTION ET SEBAS : mission d'infiltration exterieure, elle detachee sous lui
  [fenetre a poser].
- CZ2128 : demandera l'ouverture de ses verrous - Tchekhov intact apres R3 [arc a
  poser].
- ENTOMA : sa gene de ne manger que de l'humain, et le prodige des cuisines [arc a
  poser].
