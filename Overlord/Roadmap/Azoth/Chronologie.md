...
[A POSER] de R1 tranches (Narberal designee par Azoth sur demande d'Ainz ; le Roi Sage
nomme par Ainz au canon ; Clementine ecartee, simple nuisance hors champ) ; deux objets de
rang monde crees et Nazarick porte a douze ; R3 s'ouvre sur le shunt de CZ ; nouveau
...
- J0 : transfert a minuit, l'office en cours ; Momonga et Albedo dans la Salle du Trone, tout le reste a l'Eglise Impie ; S1 coupe par le Message.
- J1 : convocation - serment des Gardiens au 6e ; Ainz 1.
- J1-J2 : premiere visite de la Tresorerie (Pandora's Actor 1).
- J3 : Momonga sort avec Demiurge ; S2 ensuite.
- ~J4 : Carne - Ecriture du Soleil, Gazef, Nigun ; Momonga devient Ainz Ooal Gown (vol. 1).
- ~J8 : Momon et Nabe a E-Rantel (vol. 2).
- J10-J12 : Epees des Tenebres, Nfirea, Roi Sage (J11, nomme sur place par Ainz - canon), Sebas et Solution vers la capitale (J11), Shalltear charmee (J11), cimetiere - Clementine, Khajiit (J12).
- J13 : Shalltear tuee par Ainz, ressuscitee [DIVERGENCE RP : la resurrection est prononcee par AZOTH, sur autorisation d'Ainz obtenue avant le duel]. J14 : adamantite (vol. 3).
- J28-J37 : les hommes-lezards ; Cocytus J36-J37 ; Zaryus ressuscite J37 (vol. 4).
- apres J37 : vol. 8 (Carne, Enri, Lupusregina) ; vol. 5-6 (Sebas a Re-Estize, Huit Doigts, Jaldabaoth, Renner) ; vol. 7 (workers).
- ~6 mois : Re-Estize discute la declaration de guerre (vol. 9).
- hiver : Jircniv et Fluder a Nazarick ; Katze (vol. 9).
- printemps (~1 an) : E-Rantel cedee (vol. 10) ; les nains (vol. 11).
- ensuite, ordre seul : Roble (vol. 12-13) ; chute du Royaume, Renner demone, "mort" d'Ainz (vol. 14) ; Pays des Elfes, Zesshi (vol. 15-16). Canon publie : 16 volumes.

## Sermons et seances avec Ainz (acte, lecture A)
| Sermon | Jour | Ce qui s'y accroche (Seances/) | Seances Ainz |
|---|---|---|---|
| S1 | J0, l'office coupe par le Message pendant la conclusion | seances 1 express (Cocytus, Sebas) ; Aureole 1 (la question Wish III) ; Demiurge 1 (en chemin vers le 6e) ; jumeaux, Shalltear, Pleiades : rien | Ainz 1 (J1) : la porte de la Tresorerie, visite dans la foulee ; Pandora's Actor 1 (J1-J2) |
| S2 | J3, premier office d'Albedo | pensees profondes du corpus (Aureole 2, Solution ; Bukubukuchagama en nef pour les jumeaux) ; Demiurge 2 (Incube/Succube + plans du souverain) ; Cocytus 2 (scrupule, cours de strategie) ; Shalltear 1 (la demande) puis visite au 9e avant S3 ; l'horloge de CZ demarre ; Albedo 1 (la conquete) | - |
| S3 | J5 | BERGER PERDU : sermon creuse, "parfait" ; Albedo 2, Demiurge 3, Shalltear 2 (epiphanie), Aureole 3 ; pensees profondes hors corpus (Yuri, Lupusregina, Narberal, Entoma) | - |
| S4 | J7 | cafouillage ; Albedo 3, Demiurge 4, Aureole 4 ("medite"), Shalltear 3 ; les autres ne voient rien | Ainz 2 (J7, soir) : confession, plus d'outil admin |
| - | J8-J10 | l'Eglise se tait, sept jours sans office ; Narberal designee par Azoth et partie ; Shalltear 3, seconde moitie (exutoire) ; CZ 1 (J10) : le diagnostic demande, NON RENDU - DECLENCHEUR de la bascule martyr | - |
...
## R2 - Le Martyre [BUILDEE]
- Fichier : Roadmap_R2_Le_Martyre.md (W1).
- Bornes : depart de Momon (~J8) -> seance de la chute de Shalltear (J15). ~8 jours. Etape : BERGER PERDU -> BERGER MARTYR, la bascule EST l'evenement de l'arc.
- Titre : le mot est celui d'Ainz. Azoth appellerait ca une charge.
- Forme : huis clos a Nazarick, zero sortie, zero combat. Les volumes 2 et 3 se jouent dehors ; la difference avec R1 est qu'en R1 il cherchait, en R2 il attend, et la catastrophe entre par la porte principale.
- Jalons : l'Eglise muette sept jours ; Narberal designee ; CZ 1, le declencheur ; le nom au noir et le controle de compromission ; le huis clos a trois, Albedo et Azoth refuses ; la Tresorerie et la distribution des objets de rang monde ; Ainz 3 avant le duel ; le duel hors champ ; la resurrection prononcee par Azoth ; S5 et ses deux outils ; la seance de la chute.
- Declencheur (decision worldbuilder) : CZ2128, pas Shalltear. Un automate atteint la contradiction par le calcul en trois offices, sans foi et sans archives. La chute de Shalltear n'est pas le declencheur, c'est le DELAI - trois jours ou Azoth ne peut pas porter sa decision et regarde son dieu echouer.
...
- Bornes : ultimatum a Arwintar -> Katze (hiver).
- Jalons : Jircniv et Fluder a Nazarick - Leinas, Talent de Fluder ; Fluder passe chez Azoth ; Katze ; mort de Gazef.
- A INTEGRER AU BUILD : l'Amulette du Saint Maudit devie le Talent de Fluder - il verra un caster arcane de calibre Yggdrasil et rien cote divin, conclura pur arcaniste, et ratera le triple lanceur, c'est-a-dire son propre miroir.

## R6 - [A NOMMER] [A BUILDER]
- Bornes : printemps -> retour des nains (vol. 10-11).
- Jalons : E-Rantel cedee, Royaume Sorcier ; Shalltear en mission (Tchekhov arme en R2 : c'est Azoth qui le lui souffle) ; les nains ; Tertiaires.

## R7 - [A NOMMER] [A BUILDER]
- Bornes : Roble (vol. 12-13). Jalons : Jaldabaoth, Momon, Calca, les Custodio.

## R8 - [A NOMMER] [A BUILDER]
- Bornes : chute du Royaume (vol. 14). Jalons : Renner demone ; "mort" d'Ainz ; depart pour le Pays des Elfes.

## R9 - [A NOMMER] [A BUILDER]
- Bornes : Pays des Elfes (vol. 15-16). Jalons : Zesshi, Roi des Elfes ; Azoth en premiere ligne contre Slane ; fecondation ; deux epouses [NON TRANCHE].
- A INTEGRER AU BUILD : le rapport du chef de l'escouade Kaire a Zesshi (fil pose en R2).

## R10+ - [OUVERT]
- Canon epuise. Reste : Slane, Argland, le sort des 40 absents.
