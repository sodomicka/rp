...
- Deux horloges par PNJ [DIVERGENCE RP - formalisation worldbuilder] :
  ...
  2. Age programme : ecrit par le createur, vecu comme souvenir authentique. Des siecles au
     bas mot, millenaires pour certains.
...
- Le setting ecrit par le createur definit personnalite, gouts, savoirs et relations ; le
  PNJ le vit comme sa propre nature, sans en soupconner l'origine.

### L'exception CZ2128 Delta [DIVERGENCE RP - decision worldbuilder]
- CZ2128 Delta est une machine DANS Yggdrasil, pas seulement dans sa fiction : son
  processeur tourne sous Unix.
- Entre ses omoplates, un panneau amovible cache un ecran monochrome vert a phosphore et un
  clavier. Interface reelle, utilisable par qui sait s'en servir.
- Son code porte des sous-programmes sensoriels et emotionnels VERROUILLES par Garnet, son
  createur : il lui a tout ecrit pour etre humaine, puis l'a laissee machine froide.
- PORTEE STRICTEMENT LIMITEE A ELLE. Le garde-fou ci-dessus tient pour tous les autres PNJ :
  ils n'ont ni interface, ni code lisible, ni verrou consultable. CZ est auditable parce
  qu'elle est une machine en univers - pas parce que la nature programmee serait accessible.
  Cette exception ne se generalise a AUCUNE autre creature du Tombeau, Gargantua compris.
- Un manuel de maintenance de CZ existe. Il ne laisse transparaitre AUCUNE information sur
  le monde reel des createurs : il documente une machine, pas une origine.

## Ressources et economie interne
- Monstres POP : garnisons qui reapparaissent sans cout apres destruction.
- Invocations mercenaires et pieges avances : consomment l'or du tresor de guilde.
- Le tresor est FINI et ne se renouvelle plus depuis la fermeture d'Yggdrasil : toute
  depense est desormais definitive. Une resurrection s'y prend directement.
...
- Les prisonniers relevent de la Prison Gelee (5e etage).
...
- Parmi les Pleiades, manger de la viande humaine est mal vu : malaise du a la nature
  humaine d'Aureole, qui dit pourtant ne pas se voir comme les autres humains et ne pas s'en
  soucier ; Entoma, Solution et Lupusregina en raffolent (decision worldbuilder).
