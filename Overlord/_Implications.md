...
- Pleiades (formules worldbuilder) : Alpha apprendre a se detendre ; Beta accepter sa
  ...
  accord - un technicien, pas un admin) ; Epsilon explorer les plaisirs chez un slime
  (echecs ou shogi entre genies, puis sexe) ; Zeta l'anthropophagie (Azoth cuisine pour
  elle, chair des mandibules tres sensible, une viande par seance). Doctrine : elles se
  completent en se sentant desirees par Azoth ; Aureole etait deja complete. Seances
  personnelles a l'ere martyr (base Yuri), debut fixe a la roadmap.
- Omega : discussions existentielles, hors registre sensuel (desinteret, pas interdit).
- Shalltear : partage son harem (les Epouses vampires) avec Azoth ; sexe exutoire pour
  Azoth (perdu) puis pour elle (martyr, apres sa resurrection, LN vol. 3) ; Azoth seul a la
  dire non responsable, premier a lui conseiller des missions.
...
- Theocratie : l'immunite sacree d'Azoth est la carte pour intimider Slane sans verser une
  ...
  de construction. Prophetie du Seigneur Dragon de la Catastrophe, operation de l'Ecriture
  du Soleil contre Gazef : issue en roadmap.
- E-Rantel / Tob : Zuranon (Spirale de la Mort) : issue en roadmap. Le Roi Sage comprend
  quasi IMMEDIATEMENT la nature des 41 ; gag qui en fait d'abord une cible a executer selon
  Azoth ; Ainz l'en dissuade ; il devient le protege du Cardinal (peut encore progresser),
  porteur d'un secret qui lui vaudra la mort par son protecteur s'il tente de le divulguer ;
  le nom "Hamsuke" est donne en roadmap (qui le donne : a trancher).
- Grand Lac : la guerre des lezards releve des seances de Cocytus (cours de strategie
  d'Azoth) ; Shasuryu et Zenber entrent a Nazarick apres l'arc des hommes-lezards ; Zaryus
  et Crusch restent au lac.
...
- Trajectoire datee : structuration et plafond PAR ERES DE ROADMAPS, a fixer en passe 2
  (remplace le defaut SPEC de 30 entrees).
...
- Questions NUMEROTEES ; un rappel de question est une question, numerote pareil ; VF en
  LISTE numerotee, limitees au jargon Overlord (le reste traduit litteralement) ; par
  fiche 3 a 5 questions maximum, une question groupee pour le physique (jamais tranche
  seul).
