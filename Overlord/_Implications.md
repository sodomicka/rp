...
3. Pleiades sous les ordres d'Azoth (canon : sous Sebas). Sebas detache au service personnel d'Ainz.
4. Albedo : coeur verrouille sur Ainz (setting canon), corps en guerre de domination avec Azoth (nature succube/incube). Zero romance, statut collegues.
5. Magie alignee D&D 5e : rangs 1-9 = niveaux de sorts, rang 10 = epique, grande magie hors systeme, ressource MP. Listes de sorts D&D en VF.
6. Shalltear Bloodfallen : vampire millenaire dans un corps fige a 19 ans. Apparence ADULTE,
   remplace le design canon. Libido canon intacte. Aura et Mare : inchanges, hors de tout
...
- Azoth : hierarchie 9e etage vs domaine canon de Sebas/Pleiades - formalisee, a surveiller
  lors du lot Nazarick (organigramme).
...
## [EN ATTENTE] Message worldbuilder tronque (cloture thread 1) - A COMPLETER
- "Aureole egale de Sebas, tous deux sous Azoth, tous deux avec ..." : la fin manque.
- "descend parfois a la chapelle pour les saintes paroles, mais ..." : la fin manque.
- Ne rien supposer : demander les complements a l'ouverture du prochain thread.
...
- Thread suivant : lot PERSONNAGES (fiches noyau - Ainz, Albedo, Shalltear version actee,
  Demiurge, Gardiens, Pleiades ; Azoth a reversionner).
- Thread d'apres : PREMIERS PATCHS (passe de verification groupee + corrections).
- Restent ensuite : NouveauMonde/, Resume.md, BIBLE + Sommaire, puis passes roadmaps/fiches d'arc.

## Rappels de process
- REGISTRE SENSUEL (a graver en ANNEXE_STYLE au CODEX V1) : ellipse sur l'acte lui-meme,
  pas de dialogue pendant l'ebat, sensualite maximale autorisee hors acte (tension, avant,
  apres, marques, rapport de force). Jamais de vocabulaire anatomique cru.
- CASTING SENSUEL : Albedo, Pleiades = ok. Shalltear = EXCLUE de tout contenu sexuel ou
  sensuel (apparence physique d'une tres jeune adolescente - ligne dure, quel que soit
  son age reel). Aura et Mare = exclus totalement (enfants, aucune libido de toute facon).
...
- Prochains lots : Nazarick -> Personnages -> NouveauMonde -> Resume -> BIBLE + Sommaire.
