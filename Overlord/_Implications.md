...
Document de TRAVAIL. Jamais fetche en narration. Emplacement cible : Overlord/_Implications.md.

## Divergences actees (a integrer en BIBLE SB1/SB5 au build)
1. Gardien au 9e etage : Azoth (canon : pas de gardien au 9e).
2. Azoth jumeau de Demiurge, second niveau 100 cree par Ulbert (entorse probable au budget PNJ).
3. Pleiades sous les ordres d'Azoth (canon : sous Sebas). Sebas detache au service personnel
   d'Ainz.
...
7. REGLE GENERALE - ages des PNJ de Nazarick (decision worldbuilder) : PNJ crees in medias res.
   ...
   ecrit par le createur, vecu comme souvenir authentique). Garde-fou : cette nature
   "programmee" est INDECOUVRABLE en jeu par des moyens normaux - les souvenirs sont
   indiscernables du vecu. Seules voies d'acces : deduction (voie d'Azoth) ou revelation
   par Ainz. Shalltear : age programme millenaire, corps fige a 19 ans.
   AMENDEMENT (thread 2) : l'horloge d'existence LITTERALE ne compte pas et ne se discute
...
8. Aureole Omega et Sebas Tian : rang egal, tous deux directement sous Azoth, tous deux avec
   ...
   sanctuaire, descend parfois a la chapelle pour les saintes paroles ; aucune libido ni
   curiosite sexuelle (mots worldbuilder, thread 2 - remplacent toute paraphrase anterieure).
9. Doctrine d'Azoth (formule worldbuilder) : "Il n'offre qu'a quiconque quemande."
   ...
   Elargissement acte (thread 2) : le coeur du personnage est de faire ACCEPTER leurs peches
   aux siens et d'etre leur EXUTOIRE. A reporter dans la fiche pleine (section Psychologie).

## Azoth - decisions visuelles actees
- Cheveux NOIRS dans les deux formes (corrige "cheveux clairs" de la spec initiale).
- Yeux : rouge sang (forme humaine), rouge vif (forme vraie).
- Artworks de reference fournis en thread (v2 : Demon, Humain, Horny/embrasement) ;
...
- Attestees wiki FR : objet de rang monde, grande magie, rang (de sort), Affaissement Celeste,
  Emprise cardiaque (VF fournie par worldbuilder), Magie Sauvage, Etres Supremes, Roi Sorcier,
  rang adamantite, Sainte Ecriture du Soleil, Grand Tombeau de Nazarick, Sceptre d'Ainz Ooal Gown.
- Attestees supports officiels FR (ADN, Prime, LN Ofelbe) : grand massacre des plaines de Katze,
...
- Les deux fins de phrase ont ete fournies par le worldbuilder et integrees a la
  divergence 8. Le premier jet tronque est remplace ; ne plus s'y referer.

## Decisions actees thread 2 (cadrage lot Personnages)
- Pleiades : SIX fiches individuelles (decision worldbuilder). La nature / le peche de
  chacune releve du NOYAU et sera pose fiche par fiche.
- Matiere de TRAJECTOIRE (passe 2 - NE PAS inscrire dans les noyaux) : cheminements
  Azoth x Pleiades, formules worldbuilder - Alpha : apprendre a se detendre ;
  Beta : accepter sa bestialite ; Gamma : baisser sa garde ; Delta : decouvrir les
...
- Ordre de build du lot : 1) Azoth (reversion W0 -> W1, prototype de gabarit),
  2) reste du casting (ordre a affiner en cours de route).
- REFONTE DU SYSTEME DE MAGIE (decision worldbuilder) : abandon de l'alignement D&D 5e,
  juge inadapte au RP libre. Nouveau cadre : ECOLES DE SKYRIM + niveaux 1-9, niveau 10 =
  sorts aberrants (Ainz et assimiles). Reference des sorts canon : liste Tier Spells du
  wiki fandom (https://overlordmaruyama.fandom.com/wiki/Tier_Spells). PROPAGATION A
  PLANIFIER : Magie.md (rebuild), divergence 5 (reecriture), Systemes_Natifs.md et
  Echelle_Puissance.md (verification de compatibilite). COMPLEMENTS ACTES (thread 2) :
  les CINQ ecoles de Skyrim ; regle d'equivalence mort-vivants - les sorts de Destruction
  axes necromancie sont l'equivalent mort-vivants de l'ecole de Guerison, et vice versa ;
  grande magie = RANG 11 (ex. Sacrifices de la moisson noire), le rang 10 etant deja
  au-dela des meilleurs mages du Nouveau Monde ; patch AVANCE au thread 2 (decision
...
- TERMINOLOGIE (harmonisation MJ, veto worldbuilder possible) : "rang" (VF attestee)
  ...
  SOLDE (thread 2) : MP maintenus, JAMAIS quantifies clairement - reserve, fatigue,
  gestion narrative, pas de comptabilite de points en jeu.
- Azoth W1 (reversion livree thread 2) : age programme 666 ans, fige ; "meditation
  continue" SUPPRIMEE (erreur de pre-fiche) ; gouts actes (precher, guider ceux qui en
  ont besoin, le sexe quand on le lui propose, la recherche theologique) ; quete de la
...
- PIVOT DE PLANNING (decision worldbuilder, thread 2) : lot Personnages SUSPENDU apres
  Azoth. Prochaine etape : BIBLE BUILD B1 (+ reconciliation du Sommaire, dont Azoth
  W0 -> W1, + Resume.md). Ensuite : reste des fiches Personnages (toujours Passe 1).
  Patchs (magie, horloges) : plus tard, au thread patchs. NouveauMonde : position a
  confirmer.
- Trajectoire datee (tous persos Overlord) : structuration et plafond PAR ERES DE
...
- CADRAGE DE TON (decision worldbuilder, thread 2 - a graver en ANNEXE_STYLE au CODEX V1) :
  RP axe PSYCHOLOGIE, ROMANCE, INTROSPECTION. L'histoire d'Overlord est la toile de fond ;
  pas un RP de batailles de mages.
- REGISTRE (a graver en ANNEXE_STYLE au CODEX V1, formulation worldbuilder thread 2) :
  ellipse sur le sexe - l'acte lui-meme, pas de dialogue pendant l'ebat ; TOUT LE RESTE
...
- CASTING SENSUEL : Albedo, Pleiades = ok. Shalltear (design acte, cf. divergence 6) :
  ...
  exclusion totale, inchangee (enfants, aucune libido de toute facon). Aureole = hors
