...
> STRATE TRAJECTOIRE (exception propre a One Piece) : la Trajectoire datee des jumelles vit hors de leurs fiches noyau, a raison d'UNE PAGE PAR ROADMAP - Trajectoire_Jumelles_00 (R0) a _15 (R15), creees au fil des builds. Aucun plafond de taille : le decoupage par arc EST le plafond. L'ancienne page unique Trajectoire_Jumelles.md est SUPPRIMEE.
- Nico_Sonia.md (W8) - protagoniste ; jumelle cadette, Kaki Kaki no Mi.
- Nico_Robin.md (W6) - jumelle ainee, Hana Hana no Mi.
- Trajectoire_Jumelles_00.md (W1) - Trajectoire datee des deux jumelles, arc R0 Ohara.
- Trajectoire_Jumelles_01.md (W1) - arc R1 West Blue (porte aussi la note des pseudonymes de cavale).
- Trajectoire_Jumelles_02.md (W1) - arc R2 Grand Line.
- Trajectoire_Jumelles_03.md (W1) - arc R3 Baroque Works.
- Trajectoire_Jumelles_04.md (W1) - arc R4 Alabasta.
- Trajectoire_Jumelles_05.md (W1) - arc R5 Skypiea.
- Trajectoire_Jumelles_06.md (W1) - arc R6 Water 7.
...
- Kuzan.md (W3) - amiral Aokiji ; la condition, le juge patient.
...
- Nefertari_Vivi.md (W2) - princesse d'Alabasta ; Miss Wednesday, couverture percee puis piece ARMEE (an -1).
- Bartholomew_Kuma.md (W1) - Shichibukai adepte de Nika, pacte an 0.
- Spandam_Spandine.md (W3) - bourreaux d'Ohara et d'Enies Lobby (avec Funkfreed).
- CP9_CP0.md (W1) - fiche groupee : Lucci, Kaku, Kalifa, Blueno ; infiltration de Water 7 et Enies Lobby.
- Tom_Kokoro.md (W5) - maitre charpentier de Water 7 et secretaire de l'atelier ; foyer du sejour an -9/-8.
- Iceburg.md (W4) - apprenti senior de Tom ; president de Galley-La, maire de Water 7.
- Franky.md (W3) - Cutty Flam, apprenti cadet de Tom, cyborg ; rejoint l'equipage en R6.
- Monkey_D_Luffy.md (W5) - capitaine des Mugiwara.
- Roronoa_Zoro.md (W4) - sabreur des Mugiwara.
- Nami.md (W3) - navigatrice des Mugiwara.
- Usopp.md (W4) - tireur des Mugiwara.
- Sanji.md (W4) - cuisinier des Mugiwara.
- Tony_Tony_Chopper.md (W4) - medecin des Mugiwara.
...
- Sunny.md (W3) - le Thousand Sunny ; conception a trois, surprises des freres, chasse du Klabautermann.
...
- Chronologie.md (W10) - garde cap : chronologie des roadmaps (R0-R15), statuts, jalons et [A POSER] par arc. Boucles R0 a R6 CLOSES ; prochaine boucle : R7 Thriller Bark.
