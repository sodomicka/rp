...
- _Implications.md (W17) - journal de travail du worldbuilding ; JAMAIS fetche en narration.

### Personnages/
Description : fiches neutres des entites du monde (canon et OC promus au lore). 24 pages : 21 de la Passe 1 (close) + Sakazuki, Trajectoire_Jumelles et Nefertari_Vivi (ajoutees en Passe 2).
- Nico_Sonia.md (W6) - protagoniste ; jumelle cadette, Kaki Kaki no Mi.
- Nico_Robin.md (W5) - jumelle ainee, Hana Hana no Mi.
- Trajectoire_Jumelles.md (W2) - strate Trajectoire datee des deux jumelles, deportee des fiches Nico_Sonia / Nico_Robin.
...
- Crocodile.md (W3) - Mr. 0, protecteur-exploiteur de la periode BW.
- Nefertari_Vivi.md (W1) - princesse d'Alabasta ; Miss Wednesday, couverture percee par les jumelles (savoir a sens unique).
...
- Tom_Kokoro.md (W4) - maitre charpentier de Water 7 et secretaire de l'atelier ; foyer du sejour an -9/-8.
...
- Chronologie.md (W6) - garde cap : chronologie des roadmaps (R0-R15), statuts, jalons et [A POSER] par arc.
