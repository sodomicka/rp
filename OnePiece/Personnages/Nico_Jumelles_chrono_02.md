...
Bornes de l'arc : descente de Reverse Mountain (an -14, 14 ans) -> fuite en douce de Water 7 (an -8, 20 ans)
Roadmap : cf. Roadmap/Sonia/Roadmap_2_Grand_Line.md - Fiches noyau : cf. Personnages/Nico_Sonia.md et Personnages/Nico_Robin.md
...
## Note commune - pseudonymes de cavale
En usage sur tout cet arc : cf. Nico_Jumelles_chrono_01.md, section dediee (regle et usage residuel).

---

FIN_WIKI_PERSONNAGES_NICO_JUMELLES_CHRONO_02
