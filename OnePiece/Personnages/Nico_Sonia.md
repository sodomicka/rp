...
- Signes distinctifs stables face a Robin :
  - DEUX tresses encadrant le visage, toujours (Robin : frange, jusqu'a l'ellipse).
...
- Reference adulte : artwork worldbuilder (haut noir, longue jupe prune, bottes noires). Bras gauche : perdu a Enies Lobby (an 0) - aucune prothese sur l'arc R6 ; reeducation a partir de la traversee vers Thriller Bark (manifestations courtes, instinctives - percee du declenchement par la menace en R7) ; prothese permanente et routine seulement apres l'ellipse. Cf. BIBLE SB1 et WIKI Personnages/Trajectoire_Jumelles_06.md (perte) et _07.md (percee). Nez DEVIE vers la gauche depuis l'an 0 (brise par Spandam, ressoude de travers) - sequelle permanente.
...
## Manies et gouts
- Tire toujours la langue sur un dessin complexe destine au graphene.
- Rire : "Dareshishishishi", deformation du rire de Saul ("Dereshishishi") - amuse beaucoup Robin et Saul.
- Sommeil : a besoin de Robin pour s'endormir ; seule, elle y met des heures et se reveille de mauvaise humeur. Rituel : Robin s'endort cinq secondes apres elle ; elle se reveille cinq secondes avant Robin, le temps d'inspirer a pleins poumons l'odeur de sa moitie.
- Tradition du 6 fevrier : recoit de Robin des crayons (d'abord bon marche, payes avec l'argent de poche que Clover donne aux jumelles pour les feliciter de leur serieux) ; offre a Robin un livre d'histoire sur un pays qu'elle sait encore inconnu d'elle. Depuis toujours.
- Reve : animer un jour sa propre emission par Escargophone.
...
- Sacoche : crayons offerts par Robin + les trois carnets. Etat initial complet.
  - Carnet bleu : savoir poneglyphe des deux soeurs, outil de traduction a deux (destin : cf. BIBLE SB7).
  - Carnet rouge : compilation Nika et Joy Boy depuis l'an -22, autres dieux en annexe.
...
FIN_WIKI_PERSONNAGES_NICO_SONIA
