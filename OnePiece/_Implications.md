...
### Vers les fiches - Trajectoires R0 et ajouts
Les lignes R0 se placent EN TETE des tables (ordre chrono).
...
## Etat
- Passe 0 FAITE (BIBLE B3) ; Passe 1 CLOSE ; Passe 2 EN COURS : garde cap W2, R0 Ohara ecrite. Versions des pages : cf. Sommaire (fiches) et garde cap (roadmaps) - le journal ne les duplique plus.
- Les [A POSER] de Passe 2 vivent PAR ARC dans le garde cap (Chronologie) ; le journal ne les duplique pas.
- RESTE : boucle serree R1 West Blue, puis R2 -> R15 ; cloture de Passe 2 : relecture croisee inter-arcs ; puis Passe 3 (fiches d'arc), SETUP, CODEX V1.
