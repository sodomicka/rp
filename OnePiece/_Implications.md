...
- Version Binks des jumelles : QUEL equipage de West Blue cotoye en cavale ? (trou, a combler au build R1 West Blue).
...
- Origine et mecanique du titre "Les Lumieres de la Revolution" (dicte thread 12 : gagne a l'adolescence, R2 Grand Line) : qui le donne ? contact avec l'Armee Revolutionnaire pre-Baltigo ? Implications directes sur R9. A trancher au build R2. (Echo assume du "la Lumiere de la Revolution" canon de Robin, gagne au timeskip chez Oda - divergence de timing a cadrer.)

## Doctrine actee
- Le NOYAU d'une entite va jusqu'a sa PREMIERE ENTREE EN SCENE dans le RP (t0 pour le casting d'Ohara ; la rencontre pour les PNJ tardifs). Le posterieur vit en Trajectoire datee. A repercuter dans la SPEC (chantier worldbuilder).
- ROUTINE GARDE CAP (actee thread 11, a integrer aux instructions - chantier worldbuilder) : toute Passe 2 s'ouvre par la construction d'un GARDE-CAP, "Chronologie des roadmaps" du prota. Modele : CSM/Roadmap/Makoto/Chronologie.md. Instance OnePiece construite au thread 12 : Roadmap/Sonia/Chronologie.md (W2).
- ENRICHISSEMENTS DE FICHES EXISTANTES (acte thread 12) : le contenu est fixe et verse AU JOURNAL (section "en attente d'integration"), puis integre au prochain REBUILD COMPLET de chaque fiche, avec bump de version. Pas de fichiers patch, pas d'editions chirurgicales a la main du worldbuilder.
...
## Hors-perimetre appliques (Elbaf, canon en cours)
- Parents de Franky (revelations recentes) : exclus. Fiche : "abandonne par ses parents pirates".
- Royaume d'origine de Brook et vie pre-Rumbar (ch. 1183-1184) : exclus. Fiche : "chef du convoi de bataille d'un royaume".
...
- VENTILE au thread 12 : la liste vit desormais PAR ARC dans le garde cap (Chronologie W2 - [A POSER] de chaque bloc, fils flottants en tete). Le journal ne la duplique plus. Les resolus du thread 12 : cf. Marqueurs (Etat).
...
- Trauma tacite (AMENDE thread 10, remplace la version W4) : seules les soeurs savent. Sanji comprend sans mots (beat acte, placement R5) - le secret n'est jamais nomme ni verbalise par quiconque, jamais. -> ANNEXE_SAVOIRS du CODEX V1 (ironie dramatique cote joueur).
