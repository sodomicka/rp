...
- Le Shinigami est un cas particulier d'ame, pas un echelon de l'eveil. Toutes les bouddheites ne sont pas des Shinigami : Jizo n'en est pas un.
- Bodhisattva - eveil habite, sans ascension. Etat suffisant en soi, pas une antichambre.
- Bouddha - ascension accomplie.
...
## Convention de nom
- Les bouddheites portent nom et prenom par convention fixee par Ichibe (ex. Hyosube Ichibe, Shutara Senjumaru, Nimaiya Oetsu).
- Jizo : nom seul. Bouddheite anterieure a la convention, exempte de fait.

## Immortalite nominale
- Propriete d'Ichibe [canon] : il ne peut mourir tant qu'une personne au moins connait et appelle son nom.
- Etendue a Jizo : Ichibe fixe le nom de son frere en ere Nara (710-794), lui conferant le meme mecanisme.
- Limite structurelle incluse d'origine : l'effacement total du nom des memoires est la seule condition de fin.
...
- Quatrieme frein : peur infondee de perdre the et meditation par l'ascension. Le doute lui-meme est le frein, pas un cout reel.
- Jizo ignore que cette peur est fausse et ne s'en soucie pas : aucune quete de detachement, etat de bodhisattva pleinement habite.

---
FIN_WIKI_COSMOLOGIE_BOUDDHEITE
