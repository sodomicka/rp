...
> Chaque entree porte la version (W<N>) de la page : inventaire de versions.
...
- Zenin.md (W4) - clan Zenin : nature, gouvernance (conseil des trois patriarches), blason et tenues ceremonielles, Hei, membres, misogynie, Sort de Projection.
...
- Gojo.md (W2) - clan Gojo : Pouvoir de l'Infini, Six Yeux, clan-coquille (Satoru seul), blason (cercle + six disques a tomoe), ancetre Michizane, branche Okkotsu, paradoxe de l'unique fleuron.
...
### Suivi/
Description : fiches des personnages affectes par la narration.
- (vide : fiche protagoniste rapatriee en Personnages/Nisha/Nisha.md)
