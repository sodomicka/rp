...
- [DIVERGENCE RP] Branche Gojo : le couple y integre un clan mineur issu des Sutoku, porteur des Six Yeux. Resultat = premier guerrier parfait : Infini (espace) + Six Yeux (perception absolue de l'energie occulte). Le combo est d'une rarete extreme, ce qui a frustre le couple. (Canon : Gojo porte l'Infini et les Six Yeux ; combinaison tres rare.)
- [DIVERGENCE RP] Branche Fujiwara : scindee des Sugawara apres une mutation rendant l'Infini benin ; l'Infini finit perdu. Devient la lignee Okkotsu. Ironie voulue : dans l'Histoire, les Fujiwara firent chuter et exiler Michizane.
- [DIVERGENCE RP] Yuta Okkotsu = mutation imprevue du couple : l'Infini tacite revient sous une autre forme, la copie parfaite. (Canon : sort inne de Yuta = Copy, replique le sort inne d'autrui via Rika.)
...
## Greffes inter-clans
- [DIVERGENCE RP] Six Yeux : d'un clan mineur ex-Sutoku -> greffe sur les Gojo.
- [DIVERGENCE RP] Dix Ombres : d'un clan ex-Sugawara -> greffe sur les Zenin.
- [DIVERGENCE RP] Les domaines ne contraignent pas les greffes : la perception (Six Yeux) est rattachee aux liens/sang (Sutoku), pas a l'espace ni au temps. Arbitrage worldbuilder.

## Restriction Celeste
- [DIVERGENCE RP] N'est pas un sort. Resulte de la presence simultanee de DEUX dons de clans dans une configuration genetique rare et incompatible (produit du brassage inter-familles). Tous les melanges ne la causent pas, sinon tout le monde serait restreint ; seules de tres rares configurations.
- [DIVERGENCE RP] Effet : neutralise la manifestation des sorts. Le TYPE suit le don primordial DOMINANT du croisement. En cas d'egalite stricte : nouvelle loterie, le don gagnant est tire au hasard.
...
## Architectes
- [DIVERGENCE RP] Eien et Kenjaku (couple) = forgeurs des lignees : benediction relayee, croisements, mutations, scellements. Eien : OC, lignee Masakado/temps ; hote Meiji = Nanao Kamo. Kenjaku : issu des Kamo, parasitisme par transfert de cerveau. Fiches : cf. Personnages/Eien.md et Personnages/Kenjaku.md.

## Hors-perimetre
- [hors-perimetre] Origine ultime de l'energie occulte : JJK Modulo (2086) reformule les fleaux en Kalyans corrompus (couche alien / Simurienne). Posterieur au RP, hors focus. Ne contredit pas cette cosmogonie, qui porte l'origine des dons des familles a l'ere ancienne, pas l'origine metaphysique ultime.

---

FIN_WIKI_COSMOGONIE_TROIS_ESPRITS
