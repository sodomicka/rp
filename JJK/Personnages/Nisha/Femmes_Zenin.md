...
- Page thematique : la condition feminine Zenin. Les cas individuels detailles vivent dans leurs fiches (Maki et Mai : a venir, autre thread).

## Les sorts feminins
- Rarement interessants chez les femmes du clan. Deux seules exceptions :
  - Mai : sort de Construction, mais une faible reserve d'energie - consequence du partage gemellaire avec Maki (cf. Systemes/Jumelage) - en limite la portee.
  - Nisha : Chronostase, doublee de la Chronokinesie d'Eien. L'exception absolue (cf. plus bas).

## Le destin des femmes nees Zenin
Hors exception, deux voies, et deux seulement :
- Le mariage : on les marie dans des clans mineurs pour y etendre l'influence Zenin. Monnaie d'alliance.
- Le service : servantes a l'interieur du domaine.
...
## L'exception : Nisha
- La seule femme du clan adoree au lieu d'etre exploitee comme ventre, epouse ou servante - parce qu'elle est la plus forte. L'exception qui confirme la regle, jamais qui l'abolit (cf. fiches Naoya, Naobito, Ogi, Jinichi).
- Revers : meme elle reste un outil. On la destine au mariage Gojo - la monnaie d'alliance, version prestige (cf. fiches Naobito et Ogi).
...
- Partage gemellaire (Mai et Maki) : cf. Systemes/Jumelage.
- Cas individuels : cf. fiches Maki et Mai (a venir) et instance Nisha (Parties).

---

FIN_WIKI_PERSONNAGES_NISHA_FEMMES_ZENIN
