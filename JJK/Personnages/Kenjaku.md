...
- [DIVERGENCE RP] INTRUSION : Kenjaku peut s'introduire sous cette forme dans le for interieur d'autrui. Instance connue : 2015, la Sphere du Temps Infini ou Eien a relegue Nisha - il s'y invite et y negocie le deal avec elle avant le viol (cf. Trajectoire datee). [INCERTAIN] vecteur de l'intrusion non fixe (via Eien, qui tient alors le corps ?).
