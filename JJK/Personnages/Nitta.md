...
## Physique
- Conforme au canon, en plus jeune (etudiante) : teint clair, taille moyenne, yeux bleu pale, sourcils triangulaires clairs. Cheveux blonds (teints) mi-longs, racines sombres, frange asymetrique. Allure plus etudiante en 2012-2013, le look soigne d'assistant manager venant plus tard.
...
- (canon) Grande soeur PROTECTRICE : sa motivation premiere a embrasser la voie d'assistant manager est de garder un oeil sur son petit frere Arata. Sa principale SOURCE DE STRESS est qu'Arata ne l'ecoute pas. Affection bourrue (agacement + tendresse).
...
## Relations
Fiches propres : cf. Personnages/Nisha.md, Ijichi.md. Ici, seul le rapport a Nitta.

### Nisha - professeure / referente
- [DIVERGENCE RP] Sa professeure de 2e annee a Kyoto (2012-2013) et sa referente. PREMIERE VRAIE ELEVE de Nisha : Nisha, dont l'instinct d'education s'est eveille en cultivant les jumelles (A2) puis affine en elevant Megumi et Tsumiki, etrenne sur Nitta une PEDAGOGIE DE MERE deja forgee au foyer. Qu'une eleve SANS DON devienne sa premiere reussite pedagogique marque l'evolution de Nisha (l'elitiste qui meprisait les faibles valorise desormais la rigueur et le metier, pas seulement la puissance). Detail / dynamique fine -> roadmap.

### Arata - petit frere
- (canon) Petit frere cadet, exorciste (lui, contrairement a elle, aura une technique). Moteur affectif de Nitta : elle veille sur lui. Dans le RP, Arata est nettement plus jeune (promo Kyoto 2018-2021) - enfant pendant la scolarite d'Akari ; la protection est un trait de caractere, pas une cohabitation scolaire. Pointeur -> ere C (Arata entre en scene en 2018).

### Ijichi - modele (post-diplome)
- (canon) Une fois assistant manager a Tokyo, Nitta prend Ijichi (manager senior) pour modele du metier. Lien POSTERIEUR a B1 (elle ne rejoint Tokyo qu'apres son diplome de 2014) : pointeur seulement.

## Place dans le focus
- Premier "produit" de Nisha enseignante : la preuve, cote eleve, que la maternite a fait de la prodige une vraie pedagogue. Sa trajectoire de non-combattante illustre la valeur que Nisha accorde desormais au support (echo de son estime pour Ijichi/Nanami en A2).

## Grade et scaling
- Assistant manager : hors-classement combat, Grade 4 symbolique (role logistique, pas de scaling de combat pertinent). Cf. Power_Scaling/Doigts_de_Sukuna.md (note assistant managers).

## Chronologie noyau (jusqu'a l'entree en scene)
| Date | Jalon |
|---|---|
| ~1993 | Naissance [DIVERGENCE RP, derive ; canon muet]. Soeur ainee d'Arata, parents profanes. Sans technique. |
| 2011 | Entre a l'universite de Kyoto (promo 2011-2014), filiere assistant manager. Point d'entree en scene (ere B, arc B1). |
...
- Transfert vers Tokyo (apres diplome 2014, devient assistant manager a Tokyo) : MOTIF acte [DIVERGENCE RP] = ALIGNEMENT DE MENTALITES. Profil progressiste (rebelle, franche, libre) incompatible avec le Kyoto conservateur ; elle rejoint le pole ouvert de Tokyo par affinite. (Le canon "veiller sur Arata" ne tient pas ici, Arata restant a Kyoto - divergence assumee, motif remplace.) Evenement B2 -> a graver en trajectoire datee quand B2 sera roadmappe.
...
## Pointeurs
- Universite / corps enseignant : cf. Factions/Universite_Kyoto.md.
- Professeure / metier : cf. Personnages/Nisha.md, Ijichi.md.
- Scaling : cf. Power_Scaling/Doigts_de_Sukuna.md.

---

FIN_WIKI_PERSONNAGES_NITTA
