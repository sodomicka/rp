...
- Fige une image ou un objet touche, le gorge d'energie occulte (energie potentielle), puis vectorise ce scalaire en projectile (energie cinetique, physique pure).
- Cout en energie occulte derisoire sous Mach 3.
- Contrecoup : consommation calorique massive (mange "pour 5").
...
- Au sommet, les deux convergent : le gel EST la Chronostase complete.
...
- Maki = femme douee jetee malgre tout ; Nisha = femme si puissante qu'on ne peut la jeter, qui retourne le mepris sur les autres femmes pour rester seule sur le piedestal.
...
1. Separer les jumeaux pour les rendre autonomes (Naobito, Jinichi).
2. Ne pas legitimer une femme ni imposer sa suprematie a Kyoto (Naobito, Ogi ; proches de Gakuganji et des hautes instances).
3. Eloigner Nisha de Kyoto pour qu'Ogi cesse d'etre humilie par son frere et ses enfants (but tacite et personnel d'Ogi, devine par les jumeaux et le patriarche).
...
## Trajectoire datee (scindee par volume)
- Le devenir post-depart de Nisha (ce qu'elle DEVIENT apres 2005) est sorti de cette fiche pour le poids, et reparti par ere :
  - Ere A (post-depart, 2005-2008) : cf. Personnages/Nisha_chrono_A.md.
  - Eres ulterieures : Personnages/Nisha_chrono_B.md, etc. (a creer le moment venu).
- Convention : noyau (ce qu'elle EST, <= 2005) ici ; trajectoire datee (ce qu'elle DEVIENT, post-2005) dans les Nisha_chrono_<Ere>.md.
- Build-side, fetchee a la demande ; JAMAIS chargee en narration (la fiche d'arc tronquee tient le contexte de jeu).
