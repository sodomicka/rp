...
## Le Kama (canon, adapte)
- Sceau de sauvegarde : compresse l'essence d'un Otsutsuki dans un vaisseau marque.
- Inscription : le marqueur doit mourir pour que la sauvegarde s'active.
- Extraction progressive : le vaisseau s'otsutsukifie par paliers (donnees biologiques, puis conscience).
- A extraction complete, la conscience du marqueur peut ecraser celle du vaisseau.
...
FIN_WIKI_SYSTEMES_OTSUTSUKI_ET_MOISSON
