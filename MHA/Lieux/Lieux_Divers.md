...
- Protocoles letaux autorises contre les detenus. Reference de build : role croissant dans la trame tardive.

## Theatres canon a venir (reference de build, detail en roadmaps)
- Hosu : ville de l'arc Stain (stages).
- Kamino (Yokohama) : quartier du repaire de la Ligue et du duel public All Might / AFO.
- Camp d'ete (foret, Pussycats) : enlevement de Bakugo.

---
FIN_WIKI_LIEUX_LIEUX_DIVERS
