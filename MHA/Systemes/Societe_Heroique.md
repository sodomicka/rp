...
- Manifestation vers 4 ans en general. Absence d'Alter : minorite stigmatisee.
- Trois grands types canon : emission (activation volontaire), transformation (alteration temporaire du corps), mutation (trait corporel permanent).
- Un Alter s'use : surrexploitation = contrecoups physiques propres a chaque pouvoir.

## Cadre legal
- Usage offensif d'un Alter en public sans licence : illegal, meme en cas de bonnes intentions.
- Legitime defense toleree dans un cadre etroit ; l'intervention active est reservee aux licencies.
- Heros professionnel : metier d'Etat licencie. Remuneration publique + agences privees de heros.
- Les pires criminels sont incarceres a Tartarus (isolement extreme, protocoles letaux autorises).

## Commission de la Securite des Heros
...
### Examen d'entree (filiere heroique)
- Epreuve theorique ecrite + epreuve pratique en zone urbaine factice.
...
## Vilains et criminalite
- Vilain : criminel usant de son Alter. Spectre large, de la petite frappe au crime organise.
- La paix de l'ere All Might est un equilibre de dissuasion : son existence ecrase les ambitions criminelles.
- Menace montante a l'An 0 : la Ligue des Vilains (cf. BIBLE SB4), invisible du grand public a la rentree.

---
FIN_WIKI_SYSTEMES_SOCIETE_HEROIQUE
