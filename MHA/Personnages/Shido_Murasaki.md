...
## Alter - chronokinesie
Cf. Systemes/Chronokinesie.md pour le systeme complet. Valeurs propres a Mura (An 0) :
...
- Cerveau entraine a carburer au maximum meme sans chronokinesie : record de vitesse de l'examen theorique de Yuei battu SANS Alter.
...
## Trajectoire datee
Alimentee arc par arc apres roadmap (Passe 2). Vide a la genese.
