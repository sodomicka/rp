...
- Doctrine heritee de Chronos, appliquee sans etats d'ame : tout ennemi a portee est une menace a eliminer - en situation reelle, c'est autant de morts et de blesses en moins.
- Assume son heritage au point de vivre pour le porter - ce que sa mere aurait deteste.
- Traite le conseil du clan sans dedain, en partenaires d'infortune : c'est leur vengeance a tous qu'elle porte.
- Tutoie All Might depuis petite, l'une des seules a le faire.
- Raffole de sushis (1 nigiri = ~6 tirs standards, elle fait ce calcul).

## Alter - chronokinesie
Cf. Systemes/Chronokinesie.md pour le systeme complet (dont : contact direct obligatoire, transfert immediat, aucune programmation de tir). Valeurs propres a Mura (An 0) :
- Lecture / etude : facteur 60. Exige calme total et immobilite.
- Combat : facteur 15 soutenu ; pointes a 30 au prix de blessures (dechirures, deboitements, entorses).
- Le facteur 120 la terrifie : elle connait le chiffre par les releves cardiaques de sa mere. Plafond auto-interdit, sauf pour tuer AFO - quitte a en mourir.
- Tir standard : bille tungstene 10 g a Mach 2,5 = 3 600 J = 8,6 kcal. Calcul instantane de trajectoires et de couts.
- Regime : 5 repas de 2 150 kcal/jour. 1 repas = 250 tirs standards. Grignotage tactique en operation (barres Shido).
...
- Existence et histoire d'AFO ; c'est lui qui a tue sa mere. Promesse de silence du clan.
- Mecanique d'OFA, l'offre qui lui a ete faite, son refus.
- Identite du 9e porteur : Midoriya, assis dans sa classe. Point de desaccord avec All Might : "un OFA sans Alter propre, c'est du gachis". Elle attend que Midoriya fasse ses preuves pour le juger digne.
- Vraie forme d'All Might.
- Conviction intime : AFO est vivant. Tant qu'elle n'aura pas crache sur son cadavre, il le restera.
...
## Trajectoire datee
Alimentee arc par arc apres roadmap (Passe 2). Issues PAR DEFAUT : un RP qui diverge trace son delta en Parties/.
| Date/ere | Evenement | Delta d'etat |
|---|---|---|
| An 0 (fev) | R0 - veille d'examen : depart du domaine pour Yuei | Prologue, etat inchange |
| An 0 (fev) | R1 - examen, Centre C (aucun futur 1-A) : record de l'ecrit battu, demontre sans Alter (effacement discret d'Aizawa, soupcon de triche infirme) ; pratique dominee, sauvetages et eliminations systematiques | Jury : "niveau et comportement pro des l'entree" |
| An 0 (fev) | R1 - Zero-Pointer pulverise par doctrine (tole 900 g, Mach 4 ; epaule f30 remise seule, brulures soignees par Recovery Girl, barre Shido) | Score 100 sature, premier de l'histoire (140/100 reel) ; major absolue ; Bakugo 2e (77), sans temoin de classe |

---
FIN_WIKI_PERSONNAGES_SHIDO_MURASAKI
