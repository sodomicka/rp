...
- Etres ARTIFICIELS : un corps mineral anime par une mousse mutee. Pas de taxonomie (pas de "Gyroidae").
...
## Constitution
- Bryum sensitivum : mousse mutee (genre reel Bryum). Tapisse l'interieur du corps. Porte le reseau neural. Capable de mouvoir son mineral.
- Coeur : argile thixotrope (montmorillonite). Figee au repos, liquefiee par vibration, refigee a l'arret.
- Peau : croute de calcite en plaques jointes aux articulations, cimentee par la mousse. Dure au toucher.
...
- Homo : le haniwa, figurine d'argile enterree a la place des serviteurs d'un seigneur. "Haniwa" est le nom japonais des Gyroides au canon.
- Octopus : le takotsubo, pot en terre cuite ou la pieuvre s'abrite.
- Hirundo : la pousse des graines.

---

FIN_WIKI_SYSTEMES_GYROIDES
