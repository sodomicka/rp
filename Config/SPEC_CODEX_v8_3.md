...
Emplacement : `https://github.com/sodomicka/rp/blob/main/Config/SPEC_CODEX_v8_3.md`.
Consultation : embarquee dans la skill codex-build (`references/SPEC_CODEX_v8_3.md`) - lue en local, sans reseau. Le chemin GitHub sert a re-synchroniser la copie embarquee ou a la refetcher en secours. Copie embarquee ABSENTE du montage : fetcher la source canonique GitHub AVANT tout build. Ne JAMAIS builder sur une SPEC trouvee dans les fichiers de projet sans l'avoir confrontee a la canonique. Hierarchie : SPEC fournie en conversation > copie embarquee synchro > GitHub (source maintenue) ; en cas de contradiction embarquee/GitHub, GitHub fait foi et la copie se resynchronise. Pour les builds suivants dans le meme thread, la version en contexte fait foi. Elle porte le process que le CODEX V(N-1) ne contient pas.
...
- spec au build: SPEC_CODEX v8.3 (source: embarquee | GitHub | fournie en conversation)
